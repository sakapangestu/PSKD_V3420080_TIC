                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                <label for="Plaintext"> Teks 1</label>
                                <textarea class="form-control" name="kata" value="kata" id="kata" rows="5" placeholder="Masukkan Kalimat 1"><?= $string; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="Plaintext"> Teks 2</label>
                                <textarea class="form-control" name="kata2" value="kata2" id="kata2" rows="5" placeholder="Masukkan Kalimat 2"><?= $string2; ?></textarea>
                            </div>
                            <button type="submit" class="btn btn-primary" name="kirim" value="kirim">Encrypt</button>
                            <button type="reset" class="btn btn-warning" value="ulangi">Reset</button>
                        </form>
                        <div class="form-group">
                            <label for="Plaintext">Hasil Dari Teks 1</label>
                            <text class="form-control" name="text" id="text" rows="5"><?= $code; ?></text>
                        </div>
                        <div class="form-group">
                            <label for="Plaintext">Hasil Dari Teks 2</label>
